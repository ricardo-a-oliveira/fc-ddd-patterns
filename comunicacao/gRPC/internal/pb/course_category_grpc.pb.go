...
type CategoryServiceClient interface {
	...
	CreateCategoryBidirectStream(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategoryBidirectStreamClient, error)
}
...
func (c *categoryServiceClient) CreateCategoryBidirectStream(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategoryBidirectStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &CategoryService_ServiceDesc.Streams[1], "/pb.CategoryService/CreateCategoryBidirectStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &categoryServiceCreateCategoryBidirectStreamClient{stream}
	return x, nil
}

type CategoryService_CreateCategoryBidirectStreamClient interface {
	Send(*CreateCategoryRequest) error
	Recv() (*Category, error)
	grpc.ClientStream
}

type categoryServiceCreateCategoryBidirectStreamClient struct {
	grpc.ClientStream
}

func (x *categoryServiceCreateCategoryBidirectStreamClient) Send(m *CreateCategoryRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoryBidirectStreamClient) Recv() (*Category, error) {
	m := new(Category)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type CategoryServiceServer interface {
	...
	CreateCategoryBidirectStream(CategoryService_CreateCategoryBidirectStreamServer) error
...
func (UnimplementedCategoryServiceServer) CreateCategoryBidirectStream(CategoryService_CreateCategoryBidirectStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method CreateCategoryBidirectStream not implemented")
}
...
func _CategoryService_CreateCategoryBidirectStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).CreateCategoryBidirectStream(&categoryServiceCreateCategoryBidirectStreamServer{stream})
}

type CategoryService_CreateCategoryBidirectStreamServer interface {
	Send(*Category) error
	Recv() (*CreateCategoryRequest, error)
	grpc.ServerStream
}

type categoryServiceCreateCategoryBidirectStreamServer struct {
	grpc.ServerStream
}

func (x *categoryServiceCreateCategoryBidirectStreamServer) Send(m *Category) error {
	return x.ServerStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoryBidirectStreamServer) Recv() (*CreateCategoryRequest, error) {
	m := new(CreateCategoryRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "CreateCategoryBidirectStream",
			Handler:       _CategoryService_CreateCategoryBidirectStream_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
